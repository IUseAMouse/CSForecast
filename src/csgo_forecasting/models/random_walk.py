...
class RandomWalkModel(BaseModel):
    ...
    def forward(self, x: np.ndarray, output_len: int = 30) -> np.ndarray:
        ...
        predictions = np.zeros((len(sequences), output_len))
